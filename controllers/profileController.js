  ...
  try {
    ...
    if (req.auth?.accountType === ACCOUNT_TYPES.MERCHANT) {
      ...
      const documentStatus = {
        ...
        pan: (personalDoc?.panImage?.data || businessDoc?.panImage?.data) ? "uploaded" : "missing",
        gst: businessDoc?.gstImage?.data ? "uploaded" : "missing",
        tradeLicense: businessDoc?.tradeLicenseImage?.data ? "uploaded" : "missing",
        shopRegistration: businessDoc?.shopRegistrationImage?.data ? "uploaded" : "missing",
