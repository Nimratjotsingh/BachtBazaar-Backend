...
This folder contains module-wise API documentation for the backend.

## Quick Links

- [Common Conventions](./conventions.md)
- [User APIs](./user.md)
- [Merchant Auth APIs](./merchant-auth.md)
- [Merchant Profile APIs](./merchant-profile.md)
- [Merchant Personal Docs APIs](./merchant-personal-docs.md)
