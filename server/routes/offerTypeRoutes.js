...
router.post("/merchant", protectMerchant, createOfferType);
router.put("/merchant/:typeId", protectMerchant, updateOfferType);
router.delete("/merchant/:typeId", protectMerchant, deleteOfferType);

// --- ADMIN ACCESSIBLE ROUTES ---
router.get("/admin", protectSuperAdmin, getOfferTypes);
router.post("/admin", protectSuperAdmin, createOfferType);
router.put("/admin/:typeId", protectSuperAdmin, updateOfferType);
